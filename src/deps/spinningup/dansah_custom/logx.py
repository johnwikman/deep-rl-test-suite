...
class Logger:
    ...
    def __init__(self, output_dir=None, output_fname='progress.txt', exp_name=None, log_frequency=1):
        """
        Initialize a Logger.
        ...
        self.first_row=True
        self.real_first_row=True           # Added by @dansah
        self.log_headers = []
        self.log_current_row = {}
        self.exp_name = exp_name
        self.log_counter = 0               # Added by @dansah
        self.log_frequency = log_frequency # Added by @dansah
    ...
    def dump_tabular(self):
        ...
        if proc_id()==0:
            ...
            if self.output_file is not None:
                if self.real_first_row:
                    self.output_file.write("\t".join(self.log_headers)+"\n")
                self.output_file.write("\t".join(map(str,vals))+"\n")
                self.output_file.flush()
            self.real_first_row=False
